...
public class UnitController {
    ...
    @PostMapping()
    public ResponseEntity<UnitDto> create(@PathVariable UUID stationId, @RequestBody UnitDto dto) {
        return ResponseEntity.ok(unitService.create(stationId, dto));
    }

    @PutMapping()
    public ResponseEntity<UnitDto> update(@PathVariable UUID stationId, @RequestBody UnitDto dto) {
    ...
    @DeleteMapping()
    public ResponseEntity<Void> delete(@PathVariable UUID stationId, @RequestBody UnitDto dto) {
        if (stationId == null || dto.getId() == null) throw new IllegalArgumentException(EntityTypeException.UNIT);
