...
CREATE TABLE IF NOT EXISTS USERS (
    ...
    ROLE VARCHAR(255) CHECK (ROLE IN ('ROLE_ADMIN','ROLE_USER','ROLE_MODERATOR','DELETED_ACCOUNT')) DEFAULT 'ROLE_USER',
...
CREATE TABLE IF NOT EXISTS STATIONS (
	ID BIGINT GENERATED BY DEFAULT AS IDENTITY,
    NAME VARCHAR(50) DEFAULT 'Без названия',
...
-- Создаем таблицу грузов WEIGHTS
CREATE TABLE IF NOT EXISTS WEIGHTS (
	ID BIGINT GENERATED BY DEFAULT AS IDENTITY,
    PLANE_ID BIGINT NOT NULL,
    RUN_ID BIGINT,
    RUN_WEIGHT_MAP_KEY BIGINT,
...
-- Создаем таблицу мест измерения вибрации POINTS
...
-- Создаем таблицу режимов работы агрегата MODES
...
-- Создаем таблицу связи UNIT с MODES
CREATE TABLE IF NOT EXISTS UNITS_MODES (
    UNIT_ID BIGINT NOT NULL,
    MODES_ID BIGINT NOT NULL
);

-- Создаем таблицу связи UNIT с PLANES
CREATE TABLE UNITS_PLANES (
    UNIT_ID BIGINT NOT NULL,
    PLANES_ID BIGINT NOT NULL
);

CREATE SEQUENCE USERS_SEQ START WITH 1 INCREMENT BY 50;
CREATE SEQUENCE AUTHORITIES_SEQ START WITH 1 INCREMENT BY 50;
CREATE SEQUENCE STATIONS_SEQ START WITH 1 INCREMENT BY 50;
CREATE SEQUENCE UNITS_SEQ START WITH 1 INCREMENT BY 50;
CREATE SEQUENCE RUNS_SEQ START WITH 1 INCREMENT BY 50;
CREATE SEQUENCE MODES_SEQ START WITH 1 INCREMENT BY 50;
CREATE SEQUENCE WEIGHTS_SEQ START WITH 1 INCREMENT BY 50;
CREATE SEQUENCE PLANES_SEQ START WITH 1 INCREMENT BY 50;
CREATE SEQUENCE POINTS_SEQ START WITH 1 INCREMENT BY 50;
CREATE SEQUENCE RECORDS_SEQ START WITH 1 INCREMENT BY 50;
...
-- Заполняем таблицу плоскостей
insert into planes (NUMBER, UNIT_ID) values
    (1, 1), (1, 2), (1, 3), (1, 4),
    (1, 5), (1, 6), (1, 7);

-- Заполняем таблицу грузов
insert into weights (ID, PLANE_ID, RUN_ID, REFERENCE,
