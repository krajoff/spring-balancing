-- Создаем таблицу USERS и заполняем
create TABLE IF NOT EXISTS users (
	ID BIGINT GENERATED BY DEFAULT AS SEQUENCE,
    EMAIL VARCHAR(255),
...
-- Создаем таблицу STATIONS и заполняем
...
-- Создаем таблицу PLANES и заполняем
...
-- Создаем таблицу WEIGHTS и заполняем
...
-- Создаем таблицу POINTS и заполняем
...
-- Создаем таблицу MODES и заполняем
...
-- Создаем таблицу RECORDS и заполняем
